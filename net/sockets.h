...
constexpr options_type SOCKET_DEFAULTOPT_TCP_REUSE_PORT	= SOCKET_NONBLOCK | SOCKET_TCPNODELAY | SOCKET_REUSEADDR | SOCKET_REUSEPORT;
constexpr options_type SOCKET_DEFAULTOPT_TCP		= SOCKET_NONBLOCK | SOCKET_TCPNODELAY | SOCKET_REUSEADDR;
