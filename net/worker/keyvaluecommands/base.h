...
namespace net::worker::commands{
	...
	struct OutputBlob{
		...
		template<typename T>
		auto *allocateBytes(size_t size){
	...
	//	}
		...
		void set_container1(std::string_view s0){
			std::array<std::string_view, 1> const container{ s0 };
