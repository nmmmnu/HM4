...
#include "keyvaluecommands/cmd_sl.h"			// SLADD, SLGET, SLGETCOUNT
...
#include "keyvaluecommands/cmd_vectors2.h"		// VADD, VREM, VGET, VGETNORMALIZED, VGETRAW, VSIMFLAT, VSIMLSH, VKSET, VKGET, VKGETNORMALIZED, VGETRAW, VKSIMFLAT
