...
namespace net::worker::commands::MH{
	...
	template<class Protocol, class DBAdapter>
	struct MHBANDS : BaseCommandRO<Protocol,DBAdapter>{

		MHBANDS() : BaseCommandRO<Protocol,DBAdapter>("MHBANDS", std::begin(cmd__), std::end(cmd__)){}
